...
func ExampleSteps_AddWithTeardown(t *testing.T) {
	...
	t.Run(`on`, func(t *testing.T) {
		steps := steps.Around(func(t *testing.T) func() { value = "1"; return func() {} })

		t.Run(`each`, func(t *testing.T) {
			steps := steps.Around(func(t *testing.T) func() { value = "2"; return func() {} })

			t.Run(`nested`, func(t *testing.T) {
				steps := steps.Around(func(t *testing.T) func() { value = "3"; return func() {} })

				t.Run(`layer`, func(t *testing.T) {
					steps := steps.Around(func(t *testing.T) func() { value = "4"; return func() {} })
