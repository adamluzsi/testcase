...
- [`testcase` testing Guide](#testcase-testing-guide)
  ...
  - [`testcase` Conventions](#testcase-conventions)
    ...
    - [Domain Driven Design support with `spechelper` package](#domain-driven-design-support-with-spechelper-package)
...
### Domain Driven Design support with `spechelper` package
